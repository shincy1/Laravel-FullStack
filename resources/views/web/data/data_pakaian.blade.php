    ...
    <section class="pt-2 container pb-5">
        <div class="card text-center border-2">
            <div class="card-body"style="color: black; background-color: white">
                <h2 class="card-title">Data Pakaian</h2>
                <h4 class="card-text text-body-secondary">Halaman Data Pakaian</h4>
            </div>
        </div>
            ...
            <div class="row gap-4 justify-content-sm-around">
                ...
                <center>
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                        data-bs-target="#insertPakaianModal" style="background-color:#E48F45;">
                        Tambah Pakaian
                    </button>
                </center>
                <div class="table-responsive">
                    <table class="table align-middle table-bordered table-hover"style="box-shadow:2px 2px 4px #A6A6A6;">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer" style="background-color: whitesmoke">
                                                ...
                                                <form class="d-grid"
                                                    ...
                                                    @csrf
                                                    @method('DELETE')
                                                    <button class="btn btn-danger" style="background-color: #E48F45">Ya (Konfirmasi Hapus)</button>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
...
@section('footer')
    <div class="fixed-bottom p-3" style="background-color: #E48F45;">
