...
@section('main')
    @include('layouts.nav')
    <div class="container-flex text-center pt-3 pb-3" style="background: #E48F45">
        @if (session('success'))
    ...
    <div class="container-flex text-center p-4">
        <h5 class="" style="color: black">Metode Pembayaran</h5>
    </div>
    <div class="container d-flex flex-wrap justify-content-evenly" >
        @if ($user->user_id)
            ...
            @foreach ($paymentMethods as $method => $imageName)
                ...
                <label style="width: 200px" class="card text-bg-light p-2" style="box-shadow:2px 2px 4px #A6A6A6; border:1px solid #ccc; border-radius:16px;">
                    <img height="50px" src="{{ asset('img/' . $imageName) }}" class="mx-auto d-block" alt="...">
                    <button class="m-2 btn btn-{{ $hasPaymentMethod ? 'warning' : 'primary' }}" style="background-color:#E48F45;" type="button"
                        ...
                        <div class="modal-content">
                            ...
                            <form action="{{ $formAction }}" method="post">
                                ...
                                <div class="modal-footer" style="background-color: whitesmoke">
                                    <button type="submit" style="background-color:#E48F45"
    ...
    <div class="modal fade" data-bs-backdrop="static" id="updateUserModal" tabindex="-1"
        aria-labelledby="updateUserModalLabel" aria-hidden="true" style="background-color: ">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="{{ route('data_user.update', ['user_id' => $user->user_id]) }}" method="post"
                    ...
                    <div class="modal-body row g-0" style="background-color: whitesmoke; color: black">
                        @csrf
                        @method('PATCH')
                        <div class="d-grid">
                    ...
                    <div class="modal-footer" style="background-color: whitesmoke;">
                        <button type="submit" class="btn btn-primary" style="background-color:#E48F45" >Simpan</button>
                    </div>
                </form>
            </div>
        </div>
