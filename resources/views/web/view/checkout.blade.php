...
@section('main')
    ...
    <div class="container mt-5 text-center">
        ...
        @if ($cart)
            ...
            <div class="table-responsive">
                <form id="insert_pembelian" action="{{ route('action.create_data_pembelian') }}" method="post">
                    ...
                    <div class="d-grid m-4">
                        <button type="submit" form="insert_pembelian" class="btn btn-primary" style="background-color: #E48F45">Simpan</button>
                    </div>
                @else
            ...
            <div class="d-grid m-4">
                <button type="submit" form="insert_pembelian" class="btn btn-primary disabled" style="background-color: #E48F45">Simpan</button>
            </div>
        @endif
        </form>
        <script>
    ...
    @else
        <h3 class="display-5 fw-bold text-dark">Anda tidak memiliki Pakaian untuk dibeli</h3>
        <hr />
        <h3 class="display-7 fw-bold text-dark">Riwayat Pembelian</h3>
        <div class="table-responsive">
            <table class="table align-middle table-bordered table-hover">
                <thead class="align-middle text-center">
                    <tr>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer" style="background-color: whitesmoke">
                                        <button type="button" style="background-color: #E48F45" class="btn btn-secondary"
